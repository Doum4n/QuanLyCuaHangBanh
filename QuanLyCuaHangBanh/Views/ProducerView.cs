...
{
    public partial class ProducerView : Form, IProducerView
    {
        ...
        private void Dgv_ProducerList_SelectionChanged(object? sender, EventArgs e)
        {
            ...
            {
                selectedProducer = (Producer)dgv_ProducerList.SelectedRows[0].DataBoundItem;
        ...
        object IView.SelectedItem { get => selectedProducer; set => selectedProducer = (Producer)value; }
